...
Compiladores
Suponga que cuenta con el codigo del producto punto
el producto cruz, la multiplicacion por un escalar,
la suma, la resta, la magnitud.
Escribir una especificacion de yacc para evaluar
expresiones que involucren operaciones con vectores
***************************************
Compilacion y ejecucion
***************************************
gcc vector_calc.c -o calculadora -lm
./calculadora
*/
